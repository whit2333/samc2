...
void print_usage(){
   std::cout << "SAMC-config --libs --cflags --ldflags --inc --grid" << " ";
}

void print_libs(){
   std::cout << SAMC_CXX_LIBS << " ";
}

void print_inc(){
   std::cout << SAMC_CXX_INC_DIR << " ";
}

void print_cflags(){
   std::cout << SAMC_CXX_CFLAGS << " ";
}

void print_ldflags(){
   std::cout << SAMC_CXX_LDFLAGS << " ";
}

void print_grid(){
   std::cout << SAMC_DATA_DIR << " ";
}

void print_prefix(){
   std::cout << SAMC_PREFIX << " ";
}
